...
<body class="dark-edition">
  ...
  -->
            <div class="logo">
                <img class="img-thumbnail mx-3" src="assets/img/android-icon-192x192.png" alt="logo" style="width: 30px; height: 30px">
                <a href="../index.php" class="simple-text logo-normal d-inline">
          TITAN
        </a>
            </div>
